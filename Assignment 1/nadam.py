...
def nadam(train_x, train_y, val_x, val_y, d, hl, ol, ac, lf,  epochs = 100, eta = 0.1, init_strategy = "xavier", batch_size = 1):
  ...
  while t < epochs:
    ...
    for index, (x, y) in enumerate(zip(train_x, train_y)):
      ...
      _gW, _gb = back_propagation.back_propagation(W_look_ahead, h, x, y, _y, n_hl, ac, lf)

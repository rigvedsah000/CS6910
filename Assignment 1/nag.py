...
def nag(train_x, train_y, val_x, val_y, d, hl, ol, ac, lf, epochs, eta, init_strategy,batch_size, alpha = 0): 
    ...
    while iteration < epochs:
        ...
        for index,(x,y_true) in enumerate(zip(train_x,train_y)):
            ...
            grad_W_element , grad_b_element = back_propagation.back_propagation(W_lookahead,h,x,y_true,y_pred,len(hl),ac, lf)
